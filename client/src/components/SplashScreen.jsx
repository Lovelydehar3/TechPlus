...
export default function SplashScreen() {
  ...
  return (
    <div className="fixed inset-0 bg-[#0a0a0a] flex items-center justify-center z-[999] overflow-hidden">
      ...
      <div className="relative w-full max-w-[480px] h-full overflow-hidden opacity-100">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-20 gap-6">
        <div className="relative flex items-center justify-center">
          ...
          {/* Logo */}
          <m.div
            className="w-12 h-12 rounded-xl flex items-center justify-center font-black text-black text-lg bg-white shadow-[0_0_24px_rgba(255,255,255,0.25)] relative z-10"
